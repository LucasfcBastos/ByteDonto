...
import Art from "../../components/artAuth/ArtAuthLog"
import IMG from "../../assets/img/img_log_owner.png"
    ...
    return (
        <>
            <Art
                ...
                img={IMG}
            />
            <div className="auth-page auth-right owner">
                <div className="auth-card">
                    ...
                    <span>
                        Você está fazendo login como PROPRIETÁRIO.
                    </span>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            disabled={loading}
                        >
                            <h1>{loading ? "ENTRANDO..." : "FAZER LOGIN"}</h1>
                        </button>
                    </form>
                    ...
                    <div className="auth-footer">
                        <p className="text75">
                            Não possui cadastro?{" "}
                            <Link to="/cadastro">VAMOS CADASTRAR</Link>
                        </p>
                    </div>
