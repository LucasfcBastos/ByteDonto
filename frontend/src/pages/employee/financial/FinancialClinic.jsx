        ...
        <>
            ...
            <main className="mainBar employee">
                ...
                <div>
                    ...
                    <p className="text75">
                        Selecione uma clínica para visualizar os pagamentos das consultas.
                    </p>
                </div>
                    ...
                    {loading ? (
                        ...
                        clinicasFiltradas.map((item) => (
                            ...
                            <CampList
                                ...
                                clinic_url={`/employee/financial/${item.id}`}
...
export default FinancialClinic;